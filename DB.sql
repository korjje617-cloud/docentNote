...
-- 2. 둘 다 비우기
TRUNCATE TABLE painting_color_map;
TRUNCATE TABLE archiveColor;
...
(1,  'Red',    190, 255,   0,  90,   0,  90,  NOW()),
(2,  'Orange', 190, 255,  90, 170,   0,  90,  NOW()),
(3,  'Yellow', 180, 255, 180, 255,   0, 110,  NOW()),
(4,  'Green',    0,  90, 110, 255,   0, 110,  NOW()),

-- 하늘색 포함: B가 R,G보다 높으면 모두 Blue로
(5,  'Blue',   50, 220,  80, 230, 150, 255,  NOW()),

(6,  'Navy',    0,  70,   0,  90,  80, 175,  NOW()),
(7,  'Purple', 100, 210,   0,  90, 120, 240,  NOW()),
(8,  'Pink',   200, 255, 100, 190, 130, 220,  NOW()),
(9,  'Black',   0,  55,   0,  55,   0,  55,  NOW()),
(10, 'White',  170, 255, 160, 255, 140, 255,  NOW()),
(11, 'Brown',   55, 200,  30, 160,   0, 110,  NOW());
