...
-- Blue: R과 G의 차이가 커야 진짜 파란색. R,G가 비슷하면 회색이므로 B가 R보다 70 이상 높아야 함
-- 조건을 범위로 표현하기 어려우므로 B를 높이고 R,G 상한을 낮춤
(5,  'Blue',   50, 160,  80, 180, 170, 255,  NOW()),

-- Navy: 어둡고 B가 지배적
(6,  'Navy',    0,  70,   0,  90, 100, 175,  NOW()),

(7,  'Purple', 120, 200,   0,  80, 140, 230,  NOW()),

-- Pink: 화사한 분홍 = R이 압도적으로 높고, G와 B는 중간 이상이며 R보다 낮음
-- 핵심: R >= 200, G는 100~180, B는 130~210
(8,  'Pink',   200, 255, 100, 180, 130, 210,  NOW()),
